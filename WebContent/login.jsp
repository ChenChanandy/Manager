...
<div class="logintop">    
    ...
    <div style="text-align: center;">
    	<span style="font-size: 20px;color: white;font-family: '宋体'">用户名或密码错误</span>
    </div>
    <%} %>  
    ...
    <div class="loginbm">版权所有  cc  <a href="http://www.uimaker.com">uimaker.com</a>  仅供学习交流，勿用于任何商业用途</div>
